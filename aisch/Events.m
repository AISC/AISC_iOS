...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UILabel *nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, 300, 15)];
        nameLabel.font = [UIFont fontWithName:@"Helvetica" size:12];
        nameLabel.textColor = [UIColor blackColor];
        nameLabel.text = [EventNameArray objectAtIndex:indexPath.row];
        [elementView addSubview:nameLabel];
	}
    
    if([EventDateArray count]>0)
    {
        UILabel *dateLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 28, 130, 15)];
